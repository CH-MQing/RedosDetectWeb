...
public class AttackBean implements Serializable {
    ...
    public conflictPointHelper getConflictPoint() {
        return conflictPoint;
    }

    public void setConflictIndex(Pair<int[], int[]> conflictIndex) {
        this.conflictIndex = conflictIndex;
    }

    public void setLocateVulnerabilityRegex(String locateVulnerabilityRegex) {
        this.locateVulnerabilityRegex = locateVulnerabilityRegex;
    }

    public void setVulnerabilityRegexSource(String vulnerabilityRegexSource) {
        this.vulnerabilityRegexSource = vulnerabilityRegexSource;
    }

    public int getCirculationTimes() {
        return circulationTimes;
    }

    public void setCirculationTimes(int circulationTimes) {
        this.circulationTimes = circulationTimes;
    }
